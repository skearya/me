...
<SideNote>ill get the playlist volume slider done one of these days…</SideNote>
...
<SideNote>
	...
	elements, it really doesn't like that making that many....
</SideNote>
...
[source code for scraper and components](https://github.com/skearya/me/tree/main/src/components/spotify)
