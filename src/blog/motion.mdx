...
<SideNote>
	...
	<ul>
		<li>`lerp(start: 0, end: 1, progress: 0.5) = 0.5`</li>
		<li>`lerp(start: 0, end: 10, progress: 0.5) = 5.0`</li>
		<li>`lerp(start: 100, end: 200, progress: 0.75) = 175.0`</li>
	</ul>
</SideNote>
